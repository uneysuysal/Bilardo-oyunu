...
public class Ball
{
    ...
    public Ball() 
    {
        this(0, 0, 20, BilliardsConstant.BALL_MASS, Color.blue);    	
    }
    ...
    {   
    	this(x,y, BilliardsConstant.BALL_DIAMETER/2, BilliardsConstant.BALL_MASS, c);
    }
    ...
    public void update()
    {        	
    	velocity.x *= BilliardsConstant.ROLLING_FRICTION;
    	velocity.y *= BilliardsConstant.ROLLING_FRICTION;
    	if(Math.abs(velocity.x) < BilliardsConstant.MINIMUM_SPEED)
    	{
    		velocity.x = 0;
    	}
    	if(Math.abs(velocity.y) < BilliardsConstant.MINIMUM_SPEED)
    	{
    		velocity.y = 0;
    	}
